...
{\textbf{\href{https://gradeiq.netlify.app}{\underline{GradeIQ}}} $|$ \emph{Next.js, FastAPI, Supabase, AI APIs, Tailwind CSS}}{October 2025}{AI-powered grading platform for automated assessment of student submissions}
\resumeItemListStart
\resumeItem{Built a full-stack AI grading platform with Next.js frontend and FastAPI backend, integrating multiple AI providers (Anthropic, Google) with a multi-provider abstraction layer and Pydantic-validated structured outputs.}
\resumeItem{Engineered secure backend with JWT authentication, role-based access control, and Supabase integration; designed modular architecture with background task processing and real-time status polling for batch grading workflows.}
\resumeItem{Developed responsive UI with Tailwind CSS, shadcn/ui, and Radix UI, featuring dynamic forms, bulk operations, in-browser PDF viewing, and AI-powered mark scheme generation.}
\resumeItemListEnd
...
\resumeProjectHeading
{\textbf{AI Expense Pipeline} $|$ \emph{Python, OCR, AI APIs}}{July 2025 -- August 2025}{An automated invoice and receipt processing pipeline with configurable AI-driven extraction}
\resumeItemListStart
